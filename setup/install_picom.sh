#!/usr/bin/env bash
# DESC: Build and install yshui Picom compositor with dependencies
set -e
...
echo "Cloning yshui picom repository..."
git clone https://github.com/yshui/picom "$PICOM_BUILD_DIR/source" || {
    echo "Failed to clone yshui picom."
    exit 1
}
